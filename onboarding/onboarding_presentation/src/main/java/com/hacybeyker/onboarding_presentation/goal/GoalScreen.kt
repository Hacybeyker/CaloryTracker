package com.hacybeyker.onboarding_presentation.goal
...
fun GoalScreen(
    ...
    Box(
        ...
        Column(
            ...
            Row {
                SelectableButton(
                    text = stringResource(id = com.hacybeyker.core.R.string.lose),
                ...
                SelectableButton(
                    text = stringResource(id = com.hacybeyker.core.R.string.keep),
                ...
                Spacer(modifier = Modifier.width(spacing.spaceMedium))
                SelectableButton(
                    text = stringResource(id = com.hacybeyker.core.R.string.gain),
