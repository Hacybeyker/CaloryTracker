package com.hacybeyker.onboarding_presentation.gender
...
fun GenderScreen(
    ...
    Box(
        ...
        Column(
            ...
            Row {
                SelectableButton(
                    text = stringResource(id = com.hacybeyker.core.R.string.male),
                ...
                SelectableButton(
                    text = stringResource(id = com.hacybeyker.core.R.string.female),
